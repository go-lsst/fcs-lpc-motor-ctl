...
func indexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.html", size: 7159, mode: os.FileMode(420), modTime: time.Unix(1466006751, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
